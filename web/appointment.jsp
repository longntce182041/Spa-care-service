...
<body>
    <div class="container">
                ...
                %>
                    <tr>
                        ...
                        <td class="action-buttons">
                            <button class="btn btn-green" onclick="confirmAppointment('<%= appointment.getAppointmentId() %>')">Confirm</button>
                            <button class="btn btn-yellow" onclick="cancelAppointment('<%= appointment.getAppointmentId() %>')">Cancel</button>
        ...
        <a href="index.jsp" class="btn btn-success">Back to home page</a>
    </div>
